const help = {
  ...
  "<subject>++": "Add karma to <subject>. Can enclose in () for a subject with spaces. Can use @ to mention a user.",
  "<subject>--": "Subtract karma from <subject>. Can enclose in () for a subject with spaces. Can use @ to mention a user.",
  "!karma top": "Get the top 5 karma subjects",
  "!karma bottom": "Get the bottom 5 karma subjects",
  "!karma clear <subject>": "Clear karma for <subject>. You can't do this to a user.",
  "!karma set <amount> <subject>": "Set karma for <subject> to <amount>. Can use @ to mention a user. Only usable by admins in the admin room.",
}
